              ...
              <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <form action="{{route('filter.results')}}" method="POST">
                            @csrf
                        <div class="checkbox">
                            <label><input name="filter_value" value="high" type="checkbox" class="icheck"> From high to low </label>
                        </div>
                        <div class="checkbox">
                            <label><input name="filter_value" value="low" type="checkbox" class="icheck"> from low to high</label>
                        </div>
                    ...
                    <div class="input-group">
                      ...
                      <span class="input-group-btn">
                        <button class="btn btn-primary " type="button"><i class="fa fa-search icons"></i></button>
                      </span>
                    </div>
                    <!-- END SEARCH INPUT -->
                              ...
                              <tbody>
                                ...
                                @foreach ( $products as $product )
                                  <tr class="tabble">
                                    ...
                                    <td><a href="{{route('shoppingcart')}}"><span class="las la-shopping-bag"></span></a>
                                    </td>
                                  </tr>
                                  @php
                                      $count++
